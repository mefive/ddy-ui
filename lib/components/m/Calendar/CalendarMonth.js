...
var CalendarMonth = function (_React$PureComponent) {
  ...
  function CalendarMonth(props) {
    ...
    _this.state = {
      year: (0, _moment2.default)(_this.props.value).year()
    };
    return _this;
  }
  ...
  (0, _createClass3.default)(CalendarMonth, [{
    ...
    value: function canSelectMonth(year, month) {
      ...
      var date = (0, _moment2.default)().year(year).month(month);

      if (max) {
        return date <= (0, _moment2.default)(max);
      }

      if (min) {
        return date >= (0, _moment2.default)(min);
      }
                  ...
                  _Clickable2.default,
                  {
                    onClick: function onClick() {
                      if (_this3.canSelectMonth(_this3.state.year, index)) {
                        _this3.props.onChange((0, _moment2.default)(_this3.props.value).year(_this3.state.year).month(index).format('YYYY-MM'));
                      }
                    }
                  },
                  _react2.default.createElement(
                    'div',
                    {
                      className: (0, _classnames2.default)('month', {
                        active: month === index && _this3.state.year === (0, _moment2.default)(_this3.props.value).year(),
